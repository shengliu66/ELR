...
```
Similar early learning and memorization phenomenon is observed in Weakly Supervised Semantic Segmentation (WSSS), we have a related paper addressing it by adaptive correction: 
